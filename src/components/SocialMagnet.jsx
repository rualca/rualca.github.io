...
const SOCIALS = [
  { name: 'LinkedIn', url: 'https://www.linkedin.com/in/rubenalapont', icon: ICONS.LinkedIn },
  { name: 'GitHub', url: 'https://github.com/rualca', icon: ICONS.GitHub },
  { name: 'Mail', url: 'mailto:rruben.alapont@gmail.com', icon: ICONS.Mail },
];
