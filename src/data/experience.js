export const experience = [
  {
    ...
    location: 'Madrid',
    highlights: [
      'Owned technology strategy during a company restructuring.',
      'Designed and built the full product architecture from MVP to production platform.',
      'Hired the founding engineering team.',
